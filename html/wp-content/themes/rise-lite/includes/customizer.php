...
if( !function_exists( 'rise_lite_customizer' ) ) {
	...
	function rise_lite_customizer( $wp_customize ) {
		...
		// Yellow Button Label
		$wp_customize->add_setting( 'rise_lite_bigtitle_yellowbutton_label', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('Features','rise-lite')));
		...
		// Red Button Label
		$wp_customize->add_setting( 'rise_lite_bigtitle_redbutton_label', array('sanitize_callback' => 'zerif_sanitize_text','default' => __("What's inside",'rise-lite')));
